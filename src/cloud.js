...
Cloud.prototype.send_message = function send_message(device_id, message, ssl_config, response_cb) {
    return this.cloud.send_message(device_id, message, ssl_config, response_cb);
};

Cloud.prototype.send_action = function send_action(device_id, action, ssl_config, response_cb) {
    return this.cloud.send_action(device_id, action, ssl_config, response_cb);
};

Cloud.prototype.get_current_user_profile = function get_current_user_profile(ssl_config, response_cb) {
    return this.cloud.get_current_user_profile(ssl_config, response_cb);
};

Cloud.prototype.get_user_devices = function get_user_devices(count, properties, offset, user_id, ssl_config, response_cb) {
    return this.cloud.get_user_devices(count, properties, offset, user_id, ssl_config, response_cb);
};

Cloud.prototype.get_user_device_types = function get_user_device_types(count, shared, offset, user_id, ssl_config, response_cb) {
    return this.cloud.get_user_device_types(count, shared, offset, user_id, ssl_config, response_cb);
};

Cloud.prototype.get_user_application_properties = function get_user_application_properties(user_id, app_id, ssl_config, response_cb) {
...
Cloud.prototype.get_device = function get_device(device_id, properties, ssl_config, response_cb) {
    return this.cloud.get_device(device_id, properties, ssl_config, response_cb);
};

Cloud.prototype.get_device_token = function get_device_token(device_id, ssl_config, response_cb) {
    return this.cloud.get_device_token(device_id, ssl_config, response_cb);
};

Cloud.prototype.update_device_token = function update_device_token(device_id, ssl_config, response_cb) {
    return this.cloud.update_device_token(device_id, ssl_config, response_cb);
};

Cloud.prototype.delete_device_token = function delete_device_token(device_id, ssl_config, response_cb) {
    return this.cloud.delete_device_token(device_id, ssl_config, response_cb);
};

Cloud.prototype.delete_device = function delete_device(user_id, device_type_id, name, ssl_config, response_cb) {
